...
CREATE PROC sp_InsertInDep_byDeptID_DeptName_Location
@DeptID INT,
@DeptName VARCHAR(30)
AS
BEGIN
...
CREATE PROC sp_UpdateSal_byEID_NewSal
@EmployeeID INT,
...
CREATE PROC sp_Search_byString
@String VARCHAR(20)
AS
BEGIN
...
CREATE PROC sp_Salary_byMinSalary_MaxSalary
@MinSalary INT,
@MaxSalary INT
AS
BEGIN
...
CREATE PROC sp_UpdatePrj_byPID_Status
@ProjectID INT,
@Status VARCHAR(50)
as
begin
